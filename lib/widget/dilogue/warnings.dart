...
//           heightFactor: 0.9, // cap bottom sheet height
//           child: Padding(
...
//                         mainAxisSize: MainAxisSize.min,
//                         children: [
//                           // keep same visuals; constrain media implicitly by layout
//                           Lottie.asset(ConstantImageKey.noInternet),
//                           Container(
//                             margin: const EdgeInsets.symmetric(horizontal: 40),
//                             child: Column(
...
//         child: Text(AppGlobal.newVersionAvailableMsg(newVersion, oldVersion)),
//       ),
//       actions: [
//         TextButton(
//           onPressed: () async {
