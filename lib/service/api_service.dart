...
// import 'package:fulupo/widget/dilogue/warnings.dart';
...
//   Future<APIResp> noInternetDialogue(
//     String path, {
//     bool isPost = false,
//     Object? data,
//     bool console = true,
...
//   factory APIResp.fromJson(dynamic json) {
//     bool calculatedStatus = false;

//     // ✅ If API returns "success" field, use it directly
//     if (json['success'] != null) {
//       calculatedStatus = json['success'] == true;
//     }
//     // ✅ If API sends "message" = OTP sent successfully → treat as success
//     else if (json['message']?.toString().toLowerCase().contains('otp sent') ??
//         false) {
